/* TinyEditor
 * Modified by Jose Gonzalez <maangx@gmail.com> 
 * 
 */
...
TINY.editor = function() {
    ...
    c['subscript'] = [8, 'Subindice', 'a', 'subscript'];
    c['superscript'] = [9, 'Superindice', 'a', 'superscript'];
    c['orderedlist'] = [10, 'Insertar lista ordenada', 'a', 'insertorderedlist'];
    c['unorderedlist'] = [11, 'Insertar lista', 'a', 'insertunorderedlist'];
    c['outdent'] = [12, 'Disminuir sangria', 'a', 'outdent'];
    c['indent'] = [13, 'Aumentar sangria', 'a', 'indent'];
    c['leftalign'] = [14, 'Alinear a la izquierda', 'a', 'justifyleft'];
    c['centeralign'] = [15, 'Centrar', 'a', 'justifycenter'];
    c['rightalign'] = [16, 'Alinear a la derecha', 'a', 'justifyright'];
    c['blockjustify'] = [17, 'Justificar', 'a', 'justifyfull'];
    c['undo'] = [18, 'Deshacer', 'a', 'undo'];
    c['redo'] = [19, 'Repetir', 'a', 'redo'];
    c['image'] = [20, 'Insertar imagen', 'i', 'insertimage', 'Ingresa la URL de la imagen:', 'http://'];
    c['hr'] = [21, 'Insertar línea horizontal', 'a', 'inserthorizontalrule'];
    c['link'] = [22, 'Insertar hipervínculo', 'i', 'createlink', 'Ingresa la URL:', 'http://'];
    c['unlink'] = [23, 'Remover hipervínculo', 'a', 'unlink'];
    c['unformat'] = [24, 'Remover formato', 'a', 'removeformat'];
    c['print'] = [25, 'Imprimir', 'a', 'print'];

    function edit(n, obj) {
        // Default
        obj.controls = ['bold', 'italic', 'underline', 'strikethrough', '|', 'subscript', 'superscript', '|',
                'orderedlist', 'unorderedlist', '|', 'outdent', 'indent', '|', 'undo', 'redo',
                '|', 'image', 'hr', 'link', 'unlink'];
        obj.footer = obj.footer || true;
        this.n = n;
        window[n] = this;
        this.t = T$(obj.id);
        this.obj = obj;
        ...
        p.style.width = isNaN(this.i.width) ? this.i.width : this.i.width + 'px';
        p.appendChild(h);
        for (i; i < l; i++) {
            ...
            if (id == 'n') {
                ...
                var div = document.createElement('div'),
                    ...
                    func = x[2],
                    ex, pos = x[0] * offset;
                div.className = obj.controlclass || 'tinyeditor-control';
                div.unselectable = 'on';
        ...
        this.t.style.width = isNaN(this.i.width) ? this.i.width : this.i.width + 'px';
