        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="copyright-text text-center">
                    <p>&copy; Group Finder 2015. Todos los derechos reservados.</p>

                    <p>Diseñado por <a target="_blank" href="http://www.themeum.com">Themeum</a></p>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="<?php echo base_url(); ?>js/mention.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>js/wow.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>js/fs/fullscreenForm.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>js/tinymce/tinymce.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>js/groupfinder/gui/messages.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>js/autobahn.js"></script>
